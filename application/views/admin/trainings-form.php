...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="ml-2 text-dark"><?= isset($data) ? '<i class="fas fa-edit"></i>&nbsp;&nbsp;Edit training' : '+&nbsp;&nbsp;Add training' ?></h4>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?=base_url('Admin/Trainings')?>">Trainings</a></li>
                <li class="breadcrumb-item active"><?= isset($data) ? 'Edit' : 'Add new' ?> training</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
                     ...
                     <?php }?>   
                        <div class="row mb-4">
                            <div class="form-group col-md-6">
                                <label for="name" class="text-sm mr-2 pt-2">Training name/Heading <span class="text-danger">*</span> :</label>
                                <input type="text" value="<?= isset($data) ? $data->name: '' ?>" class="form-control" name="name" id="name" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="img" class="text-sm mr-2 pt-2">Image for training <?= isset($data) ? '' : '<span class="text-danger">*</span>' ?> :</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="duration" class="text-sm mr-2 pt-2">Duration:</label>
                        ...
                        <div class="row ml-1">
                            <a href="<?=base_url('Admin/Trainings')?>" class="btn btn-secondary mr-3 col-md-2"><strong>x</strong> Cancel</a>
                            <button type="submit" class="btn btn-primary col-md-2"><?= isset($data) ? '<i class="fa fa-recycle"></i> Update' : '<strong>+ </strong> Post' ?></button>
                        </div>
                    </form>
