                ...
                <div class="header-video xl-header-vid col-md-7 px-0 pb-0">
                     <a href="#" class="play">
                         <svg id="Group_54" data-name="Group 54" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 106 106">
                             ...
                             <circle id="outer" cx="53" cy="53" r="52.5" fill="none"/>
                             </g>
           ...
           <div class="row mt-sm-5 mt-3 header-cards">
              <div class="col-lg-6 column">
                   <div class="row flex-md-nowrap" >
                       <div class="col-md-4 bg-light px-3 pt-4 pb-2 cardL">
                           <svg id="Web-design-icon" xmlns="http://www.w3.org/2000/svg" width="44.497" height="44.5" viewBox="0 0 44.497 44.5">
                       ...
                       <div class="col-md-4 bg-light px-3 pt-4 pb-2  mx-2 cardM">
                           <svg id="Planning-icon" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45">
                       ...
                       <div class="col-md-4 bg-light px-3 pt-4 pb-2  cardR">
                           <svg id="Web-icon" xmlns="http://www.w3.org/2000/svg" width="45.867" height="45.867" viewBox="0 0 45.867 45.867">
   ...
   <section class="services">
       ...
       <img src="<?=base_url()?>assets/patterns/t2.png" alt="p" class="pattern2">
       <img src="<?=base_url()?>assets/patterns/r1.png" alt="p" class="pattern3">
       <div class="container">
           <div class="row justify-content-center flex-wrap-reverse">
               <div class="col-md-5 ml-md-0 ml-5 no-head mr-0 mr-sm-0 mt-md-0 mt-5">
                   <div class="service pl-5 pr-3 py-5 text-white">
                        <span>
                   ...
                   <div class="service mt-5 pl-5 pr-3 py-5 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="90" height="90" viewBox="0 0 140.105 140.105">
                            <defs>
                            <clipPath id="clip-path">
                                <circle id="Oval" cx="70.052" cy="70.052" r="70.052" fill="#0071d8"/>
   ...
   <section class="training">
    <img src="<?=base_url()?>assets/patterns/r6.png" alt="p" class="pattern1">
    <img src="<?=base_url()?>assets/patterns/wave2.png" alt="p" class="pattern2">
       <div class="container">
   ...
   <section class="huge mt-5 bg-blue">
       <div class="container pt-3">
           <div class="row flex-wrap-reverse">
               ...
               <div class="col-md-5 text-center align-self-center">
                    <img src="<?=base_url()?>assets/thumb.png" class="thumb" width="220" alt="thumb">  
               </div>
           </div>
       </div>
   </section>
   ...
   <div class="container counts-container">
    <div class="row counts text-center text-white bg-blue flex-nowrap">
        ...
        <div class="col-4 pt-sm-5 pb-sm-5 pt-4 pb-3 px-3 mid-count">
             <h1 class="mb-4"><span class="lato counter" data-target="99">0</span>%</h1>
             <p>SATISFIED <br> CLIENTS</p>
        </div>
        <div class="col-4 pt-sm-5 pb-sm-5 pt-4 pb-3 px-3">
             <h1 class="lato mb-4 counter" data-target="234">0</h1>
             <p>SUCCESS <br> CAMPAIGN</p>
        </div>
    </div>
   </div>
